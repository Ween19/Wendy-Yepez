...
require_once "../../config/conexion.php";
    ...
    $sql = "INSERT INTO historial_habitos (id_habito, id_usuario, fecha, hora, estado) VALUES (:id, :uid, :fecha, :hora, 1)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([':id' => $id_habito, ':uid' => $id_usuario, ':fecha' => $hoy, ':hora' => $hora]);
